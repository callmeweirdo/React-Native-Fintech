...
var require_insertStyleRule_native = __commonJS({
  "../web/dist/cjs/helpers/insertStyleRule.native.js"(exports2, module2) {
    ...
    var totalSelectorsInserted = /* @__PURE__ */ new Map(), allSelectors = {}, allRules = {}, insertedTransforms2 = {}, getAllSelectors = function() {
      return allSelectors;
    }, getAllRules = function() {
...
var require_useMedia_native = __commonJS({
  "../web/dist/cjs/hooks/useMedia.native.js"(exports2, module2) {
    ...
    var mediaState2 = {}, mediaQueryConfig2 = {}, getMedia2 = function() {
      return mediaState2;
...
var require_ThemeManager_native = __commonJS({
  "../web/dist/cjs/helpers/ThemeManager.native.js"(exports2, module2) {
    ...
    function getState(props, manager) {
      ...
      return props.debug === "verbose" && import_constants.isClient && (console.groupCollapsed("ThemeManager.getState()"), console.info({
        props,
        baseName,
        base,
        min,
...
var require_createShallowSetState_native = __commonJS({
  "../web/dist/cjs/helpers/createShallowSetState.native.js"(exports2, module2) {
    ...
    function mergeIfNotShallowEqual(prev, next, isDisabled, debug) {
      return isDisabled || !prev || !next || isEqualShallow(prev, next) ? prev || next : _object_spread2({}, prev, next);
    }
  ...
  "../web/dist/cjs/hooks/useTheme.native.js"(exports2, module2) {
    ...
    var useTheme = function() {
      ...
      var keys = (0, import_react3.useRef)([]), changedThemeState = useChangeThemeEffect(props, !1, keys.current, import_constants.isServer ? void 0 : function() {
        ...
        return next;
      }), themeManager = changedThemeState.themeManager, state = changedThemeState.state, themeProxied = (0, import_react3.useMemo)(function() {
...
var require_Tamagui_native = __commonJS({
  "../web/dist/cjs/Tamagui.native.js"(exports2, module2) {
    ...
    var Helpers = __toESM2(require_index_native4()), import_config = require_config_native(), import_insertStyleRule = require_insertStyleRule_native(), import_useMedia = require_useMedia_native(), import_useTheme = require_useTheme_native(), Tamagui = function() {
      if (0)
        var TamaguiManager;
  ...
  "../web/dist/cjs/helpers/propMapper.native.js"(exports2, module2) {
    ...
    var fontShorthand = {
      ...
      if (theme && value in theme) {
        if (valOrVar = theme[value], styleState.skipThemeTokenResolution && valOrVar != null && valOrVar.val) return value;
        hasSet = !0;
      } else {
    ...
    function createComponent(staticConfig) {
      ...
      var Component = staticConfig.Component, isText = staticConfig.isText, isZStack = staticConfig.isZStack, isHOC = staticConfig.isHOC, _staticConfig_validStyles = staticConfig.validStyles, _$validStyles = _staticConfig_validStyles === void 0 ? {} : _staticConfig_validStyles, _staticConfig_variants = staticConfig.variants, variants = _staticConfig_variants === void 0 ? {} : _staticConfig_variants, component = /* @__PURE__ */ (0, import_react3.forwardRef)(function(propsIn, forwardedRef) {
        ...
        if ("themeInverse" in props && (themeStateProps.inverse = props.themeInverse), "theme" in props && (themeStateProps.name = props.theme), typeof curStateRef.isListeningToTheme == "boolean" && (themeStateProps.shouldUpdate = function() {
          ...
          if (console.info("%c ".concat(banner, " (hydrated: ").concat(isHydrated, ") (unmounted: ").concat(state.unmounted, ")"), "background: green; color: white;"), !import_constants.isServer) var ch, childLog;
        }
    ...
    function createTamagui(configIn) {
      ...
      var specificTokens = {}, themeConfig = function() {
        ...
        for (var key2 in tokens) for (var skey in tokens[key2]) {
          ...
          specificTokens["$".concat(key2, ".").concat(skey)] = variable, import_constants.isWeb && ((0, import_registerCSSVariable.registerCSSVariable)(variable), declarations.push((0, import_registerCSSVariable.variableToCSS)(variable, key2 === "zIndex")));
        }
        if (import_constants.isWeb) {
