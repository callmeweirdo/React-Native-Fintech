...
` && console.error(`Unexpected text node: ${item}. A text node cannot be a child of a <View>.`);
    ...
    if (groupName && subGroupContext && (content = /* @__PURE__ */jsx(ComponentContext.Provider, {
      ...
      children: content
    })), process.env.NODE_ENV === "development" && time && time`group-context`, content = disableTheme ? content : getThemedChildren(themeState, content, themeStateProps, !1, stateRef), process.env.NODE_ENV === "development" && time && time`themed-children`, process.env.NODE_ENV === "development" && props.debug === "visualize" && (content = /* @__PURE__ */jsx(ThemeDebug, {
      themeState,
      themeProps: props,
      children: content
    ...
    if (process.env.TAMAGUI_REACT_19) {
      const {
        ...
        keys = Object.keys(splitStyles.rulesToInsert);
      keys.length && (content = /* @__PURE__ */jsxs(Fragment2, {
        children: [content, keys.map(key => {
...
function spacedChildren(props) {
  ...
  for (let [index, child] of childrenList.entries()) {
    ...
    next && !isEmpty && !isUnspaced(next) && (separator ? (hasSpace && final.push(createSpacer({
      ...
      space,
      spaceFlex
    })), final.push( /* @__PURE__ */jsx(Fragment, {
      children: separator
